  ...
  if (type === 'vertical') {
    return (
      <div className="h-10 w-full relative flex items-center justify-center">
        ...
        <div className="absolute top-0 bottom-0 w-[2px] bg-gradient-to-b from-guardian-slate/40 via-guardian-slate/10 to-guardian-slate/40" />
        ...
        <svg className="w-4 h-full relative z-10" viewBox="0 0 16 40" fill="none">
          ...
          <motion.circle
            ...
            r="2"
            fill="var(--color-guardian-cyan)"
            className="filter drop-shadow-[0_0_4px_rgba(56,189,248,0.4)]"
            animate={{
              cy: [-5, 45],
            }}
            transition={{
        ...
        <svg className="w-full h-full" viewBox="0 0 200 120" fill="none" preserveAspectRatio="none">
          <defs>
            <linearGradient id="left-flow-grad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="var(--color-guardian-cyan)" stopOpacity="0.1" />
              <stop offset="100%" stopColor="var(--color-guardian-cyan)" stopOpacity="0.4" />
            </linearGradient>
          </defs>
          ...
          <path
            ...
            stroke="var(--color-guardian-slate)"
            strokeWidth="2"
            strokeDasharray="4 4"
            opacity="0.3"
          />
      ...
      <svg className="w-full h-full" viewBox="0 0 200 140" fill="none" preserveAspectRatio="none">
        <defs>
          <linearGradient id="right-flow-grad" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="var(--color-guardian-cyan)" stopOpacity="0.4" />
            <stop offset="100%" stopColor="var(--color-guardian-cyan)" stopOpacity="0.1" />
          </linearGradient>
        </defs>
